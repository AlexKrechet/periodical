...
<form name="create_a_periodical" action="ShoppingServlet" method="POST">
    <fieldset>
        <table>
            <tr>
                <td>Name:</td>
                <td><input class="dataField" id="periodical_name" type="text" name="periodical_name" value=""/><br/>
                </td>
            </tr>
            <tr>
                <td>Price:</td>
                <td><input class="dataField" id="periodical_price" input type="number" min="0.01" max="1000000"
                           step="0.01"
                           name="periodical_price" value="0"/><br/></td>
            </tr>
            <tr>
                <td>Publisher:</td>
                <td>
            ...
            <tr>
                <td></td>
                <td><input type="hidden" name="action" value="ADD_NEW_PERIODICAL_BY_ADMIN">
                    <input type="submit" class="myButton" value="Create a periodical"/>
                </td>
            </tr>
        </table>
    </fieldset>
